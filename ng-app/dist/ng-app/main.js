...
var GuildService = /** @class */ (function () {
    function GuildService(http) {
        this.http = http;
        this.apiUrl = 'http://localhost:4000/api';
        this.guildUrl = this.apiUrl + '/bots/guilds';
    }
